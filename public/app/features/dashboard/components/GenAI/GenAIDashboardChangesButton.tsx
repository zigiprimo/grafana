...
const CHANGES_GENERATION_PREFIX_PROMPT = [
  ...
  'Dashboards are stored as json. You will be given human-readable output describing which keys are changed, and how.',
].join('.\n');
    ...
    const migrationMessages = [
      ...
      },
      {
        content:
          ...
          `Ignore other changes and do not include them in the summary.\n` +
