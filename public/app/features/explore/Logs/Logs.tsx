...
import { LogsLeftPane } from './LogsLeftPane';
  ...
  render() {
    ...
    return (
      <>
        ...
        <div className={styles.splitPaneDiv}>
          <SplitPaneWrapper maxSize={-200} paneSize={200} primary="first">
            <LogsLeftPane
              logRow={this.state.selectedRow}
              logRows={logRows}
