...
import { Badge, Button, Dropdown, Icon, Menu, TagList, Tooltip, useStyles2 } from '@grafana/ui';
        ...
        <Dropdown
          overlay={
            <Menu>
              ...
              <Menu.Item label="Re-order rules" icon="exchange-alt" disabled={isProvisioned} />
              <Menu.Divider />
  ...
  return (
    <div className={styles.alertListItemWrapper}>
      <Stack direction="row" alignItems={'start'} gap={1}>
        <Span color={state ? color[state] : 'secondary'}>
          ...
          <Stack direction="column" gap={1}>
            <div className={styles.receiverDescriptionRow}>
              <Stack direction="column" gap={0.5}>
                <Stack direction="row" alignItems="center" gap={1}>
                  <Span variant="body" color="maxContrast" weight="bold">
                    {name}
                  </Span>
                  <TagList displayMax={3} tags={['team=sysops', 'type=network', 'vendor=ubiquity']} />
                </Stack>
                {summary && (
        ...
        <Dropdown
          overlay={
            <Menu>
              ...
              <Menu.Item label="Manage permissions" icon="lock" />
            </Menu>
          }
        >
          <Button
