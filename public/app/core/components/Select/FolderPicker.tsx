  ...
  const createNewFolder = useCallback(
    async (folderName: string) => {
      if (folderWarning?.warningCondition(folderName)) {
        reportInteraction('folder_picker_create_folder_validation_fail');
        return false;
      }
      ...
      if (newFolder.uid) {
        reportInteraction('folder_picker_create_folder_success');
        ...
        reportInteraction('folder_picker_create_folder_fail');
