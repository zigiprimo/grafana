...
import { CloudWatchJsonData, CloudWatchMetricsQuery } from '../../types';
...
export interface Props
  extends QueryEditorProps<CloudWatchMetricsDatasource, CloudWatchMetricsQuery, CloudWatchJsonData> {}
...
export const MetricsQueryEditor = (props: Props) => {
  ...
  const onChange = (query: CloudWatchMetricsQuery) => {
