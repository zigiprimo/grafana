...
export class CloudWatchMetricsDatasource
  extends DataSourceWithBackend<CloudWatchMetricsQuery, CloudWatchJsonData>
  implements DataSourceWithLogsContextSupport<CloudWatchLogsQuery>
{
  ...
  interpolateVariablesInQueries(queries: CloudWatchMetricsQuery[], scopedVars: ScopedVars): CloudWatchMetricsQuery[] {
    if (!queries.length) {
      return queries;
    }
