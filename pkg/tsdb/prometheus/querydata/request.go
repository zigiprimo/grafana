...
func New(
	...
	if features.IsEnabledGlobal(featuremgmt.FlagDisablePrometheusExemplarSampling) {
	...
	return &QueryData{
		...
		ID:                 settings.ID,
		URL:                settings.URL,
		enableDataplane:    features.IsEnabledGlobal(featuremgmt.FlagPrometheusDataplane),
