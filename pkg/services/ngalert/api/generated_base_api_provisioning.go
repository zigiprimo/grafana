	...
	api.RouteRegister.Group("", func(group routing.RouteRegister) {
		group.Delete(
			...
			metrics.Instrument(
				...
				api.hook(srv.RouteDeleteAlertRule),
				m,
			),
		)
		group.Delete(
			...
			metrics.Instrument(
				...
				api.hook(srv.RouteDeleteContactpoints),
				m,
			),
		)
		group.Delete(
			...
			metrics.Instrument(
				...
				api.hook(srv.RouteDeleteMuteTiming),
				m,
			),
		)
		group.Delete(
			...
			metrics.Instrument(
				...
				api.hook(srv.RouteDeleteTemplate),
				m,
			),
		)
		group.Get(
			...
			metrics.Instrument(
				http.MethodGet,
				"/api/v1/provisioning/alert-rules/{UID}",
				api.hook(srv.RouteGetAlertRule),
				m,
			),
		)
		group.Get(
			...
			metrics.Instrument(
				...
				api.hook(srv.RouteGetAlertRuleExport),
				m,
			),
		)
		group.Get(
			...
			metrics.Instrument(
				...
				api.hook(srv.RouteGetAlertRuleGroup),
				m,
			),
		)
		group.Get(
			...
			metrics.Instrument(
				...
				api.hook(srv.RouteGetAlertRuleGroupExport),
				m,
			),
		)
		group.Get(
			...
			metrics.Instrument(
				...
				api.hook(srv.RouteGetAlertRules),
				m,
			),
		)
		group.Get(
			...
			metrics.Instrument(
				...
				api.hook(srv.RouteGetAlertRulesExport),
				m,
			),
		)
		group.Get(
			...
			metrics.Instrument(
				...
				api.hook(srv.RouteGetContactpoints),
				m,
			),
		)
		group.Get(
			...
			metrics.Instrument(
				http.MethodGet,
				"/api/v1/provisioning/mute-timings/{name}",
				api.hook(srv.RouteGetMuteTiming),
				m,
			),
		)
		group.Get(
			...
			metrics.Instrument(
				...
				api.hook(srv.RouteGetMuteTimings),
				m,
			),
		)
		group.Get(
			...
			metrics.Instrument(
				...
				api.hook(srv.RouteGetPolicyTree),
				m,
			),
		)
		group.Get(
		...
		group.Get(
			...
			metrics.Instrument(
				...
				api.hook(srv.RouteGetTemplates),
				m,
			),
		)
		group.Post(
			...
			metrics.Instrument(
				http.MethodPost,
				"/api/v1/provisioning/alert-rules",
				api.hook(srv.RoutePostAlertRule),
				m,
			),
		)
		group.Post(
			...
			metrics.Instrument(
				http.MethodPost,
				"/api/v1/provisioning/contact-points",
				api.hook(srv.RoutePostContactpoints),
				m,
			),
		)
		group.Post(
			...
			metrics.Instrument(
				http.MethodPost,
				"/api/v1/provisioning/mute-timings",
				api.hook(srv.RoutePostMuteTiming),
				m,
			),
		)
		group.Put(
			...
			metrics.Instrument(
				http.MethodPut,
				"/api/v1/provisioning/alert-rules/{UID}",
				api.hook(srv.RoutePutAlertRule),
				m,
			),
		)
		group.Put(
			...
			metrics.Instrument(
				http.MethodPut,
				"/api/v1/provisioning/folder/{FolderUID}/rule-groups/{Group}",
				api.hook(srv.RoutePutAlertRuleGroup),
				m,
			),
		)
		group.Put(
			...
			metrics.Instrument(
				http.MethodPut,
				"/api/v1/provisioning/contact-points/{UID}",
				api.hook(srv.RoutePutContactpoint),
				m,
			),
		)
		group.Put(
			...
			metrics.Instrument(
				http.MethodPut,
				"/api/v1/provisioning/mute-timings/{name}",
				api.hook(srv.RoutePutMuteTiming),
				m,
			),
		)
		group.Put(
			...
			metrics.Instrument(
				http.MethodPut,
				"/api/v1/provisioning/policies",
				api.hook(srv.RoutePutPolicyTree),
				m,
			),
		)
		group.Put(
		...
		group.Delete(
			...
			metrics.Instrument(
				http.MethodDelete,
				"/api/v1/provisioning/policies",
				api.hook(srv.RouteResetPolicyTree),
				m,
			),
		)
