	...
	api.RouteRegister.Group("", func(group routing.RouteRegister) {
		group.Delete(
			...
			metrics.Instrument(
				...
				api.hook(srv.RouteDeleteNGalertConfig),
				m,
			),
		)
		group.Get(
			...
			metrics.Instrument(
				...
				api.hook(srv.RouteGetAlertmanagers),
				m,
			),
		)
		group.Get(
			...
			metrics.Instrument(
				http.MethodGet,
				"/api/v1/ngalert/admin_config",
				api.hook(srv.RouteGetNGalertConfig),
				m,
			),
		)
		group.Get(
		...
		group.Post(
			...
			metrics.Instrument(
				http.MethodPost,
				"/api/v1/ngalert/admin_config",
				api.hook(srv.RoutePostNGalertConfig),
				m,
			),
		)
