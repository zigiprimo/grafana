...
type Rule interface {
	run(key models.AlertRuleKey, sch *schedule) error
...
func (r *alertRuleInfoRegistry) getOrCreateInfo(context context.Context, key models.AlertRuleKey, factory RuleFactoryFunc) (Rule, bool) {
	r.mu.Lock()
	defer r.mu.Unlock()
