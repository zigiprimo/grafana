...
func TestAlertRuleService(t *testing.T) {
	...
	t.Run("group creation should set the right provenance", func(t *testing.T) {
		...
		err := ruleService.ReplaceRuleGroup(context.Background(), u, orgID, group, models.ProvenanceAPI)
		require.NoError(t, err)

		readGroup, err := ruleService.GetRuleGroup(context.Background(), u, orgID, "my-namespace", "group-test-1")
		require.NoError(t, err)
		require.NotEmpty(t, readGroup.Rules)
		for _, rule := range readGroup.Rules {
			_, provenance, err := ruleService.GetAlertRule(context.Background(), u, orgID, rule.UID)
			require.NoError(t, err)
	...
	t.Run("alert rule group should be updated correctly", func(t *testing.T) {
		...
		err = ruleService.UpdateRuleGroup(context.Background(), u, orgID, rule.NamespaceUID, rule.RuleGroup, 120)
		require.NoError(t, err)

		rule, _, err = ruleService.GetAlertRule(context.Background(), u, orgID, rule.UID)
		require.NoError(t, err)
	...
	t.Run("if a folder was renamed the interval should be fetched from the renamed folder", func(t *testing.T) {
		...
		_, err = ruleService.UpdateAlertRule(context.Background(), u,
	...
	t.Run("group creation should propagate group title correctly", func(t *testing.T) {
		...
		readGroup, err := ruleService.GetRuleGroup(context.Background(), u, orgID, "my-namespace", "group-test-3")
		require.NoError(t, err)
		require.NotEmpty(t, readGroup.Rules)
		for _, rule := range readGroup.Rules {
	...
	t.Run("updating a rule group's top level fields should bump the version number", func(t *testing.T) {
		...
		rule, _, err = ruleService.GetAlertRule(context.Background(), u, orgID, ruleUID)
		require.NoError(t, err)
		require.Equal(t, int64(1), rule.Version)
		require.Equal(t, int64(60), rule.IntervalSeconds)

		err = ruleService.UpdateRuleGroup(context.Background(), u, orgID, namespaceUID, ruleGroup, newInterval)
		require.NoError(t, err)
	...
	t.Run("updating a group by updating a rule should bump that rule's data and version number", func(t *testing.T) {
		...
		err := ruleService.ReplaceRuleGroup(context.Background(), u, orgID, group, models.ProvenanceAPI)
		require.NoError(t, err)
		updatedGroup, err := ruleService.GetRuleGroup(context.Background(), u, orgID, "my-namespace", "group-test-5")
		require.NoError(t, err)

		updatedGroup.Rules[0].Title = "some-other-title-asdf"
		err = ruleService.ReplaceRuleGroup(context.Background(), u, orgID, updatedGroup, models.ProvenanceAPI)
		require.NoError(t, err)

		readGroup, err := ruleService.GetRuleGroup(context.Background(), u, orgID, "my-namespace", "group-test-5")
		require.NoError(t, err)
		require.NotEmpty(t, readGroup.Rules)
	...
	t.Run("updating a group to temporarily overlap rule names should not throw unique constraint", func(t *testing.T) {
		...
		err := ruleService.ReplaceRuleGroup(context.Background(), u, orgID, group, models.ProvenanceAPI)
		require.NoError(t, err)
		updatedGroup, err := ruleService.GetRuleGroup(context.Background(), u, orgID, "my-namespace", "overlap-test")
		require.NoError(t, err)
		...
		readGroup, err := ruleService.GetRuleGroup(context.Background(), u, orgID, "my-namespace", "overlap-test")
		require.NoError(t, err)
		require.NotEmpty(t, readGroup.Rules)
	...
	t.Run("updating a group to swap the name of two rules should not throw unique constraint", func(t *testing.T) {
		...
		err := ruleService.ReplaceRuleGroup(context.Background(), u, orgID, group, models.ProvenanceAPI)
		require.NoError(t, err)
		updatedGroup, err := ruleService.GetRuleGroup(context.Background(), u, orgID, "my-namespace", "swap-test")
		require.NoError(t, err)
		...
		readGroup, err := ruleService.GetRuleGroup(context.Background(), u, orgID, "my-namespace", "swap-test")
		require.NoError(t, err)
		require.NotEmpty(t, readGroup.Rules)
		require.Len(t, readGroup.Rules, 2)
	...
	t.Run("updating a group that has a rule name cycle should not throw unique constraint", func(t *testing.T) {
		...
		err := ruleService.ReplaceRuleGroup(context.Background(), u, orgID, group, models.ProvenanceAPI)
		require.NoError(t, err)
		updatedGroup, err := ruleService.GetRuleGroup(context.Background(), u, orgID, "my-namespace", "cycle-test")
		require.NoError(t, err)
		...
		readGroup, err := ruleService.GetRuleGroup(context.Background(), u, orgID, "my-namespace", "cycle-test")
		require.NoError(t, err)
		require.NotEmpty(t, readGroup.Rules)
	...
	t.Run("updating a group that has multiple rule name cycles should not throw unique constraint", func(t *testing.T) {
		...
		err := ruleService.ReplaceRuleGroup(context.Background(), u, orgID, group, models.ProvenanceAPI)
		require.NoError(t, err)
		updatedGroup, err := ruleService.GetRuleGroup(context.Background(), u, orgID, "my-namespace", "multi-cycle-test")
		require.NoError(t, err)
		...
		readGroup, err := ruleService.GetRuleGroup(context.Background(), u, orgID, "my-namespace", "multi-cycle-test")
		require.NoError(t, err)
		require.NotEmpty(t, readGroup.Rules)
	...
	t.Run("updating a group to recreate a rule using the same name should not throw unique constraint", func(t *testing.T) {
		...
		readGroup, err := ruleService.GetRuleGroup(context.Background(), u, orgID, "my-namespace", "recreate-test")
		require.NoError(t, err)
		require.NotEmpty(t, readGroup.Rules)
		require.Len(t, readGroup.Rules, 1)
	...
	t.Run("updating a group to create a rule that temporarily overlaps an existing should not throw unique constraint", func(t *testing.T) {
		...
		err := ruleService.ReplaceRuleGroup(context.Background(), u, orgID, group, models.ProvenanceAPI)
		require.NoError(t, err)
		updatedGroup, err := ruleService.GetRuleGroup(context.Background(), u, orgID, "my-namespace", "create-overlap-test")
		require.NoError(t, err)
		...
		readGroup, err := ruleService.GetRuleGroup(context.Background(), u, orgID, "my-namespace", "create-overlap-test")
		require.NoError(t, err)
		require.NotEmpty(t, readGroup.Rules)
		require.Len(t, readGroup.Rules, 2)
	...
	t.Run("alert rule provenace should be correctly checked when writing groups", func(t *testing.T) {
		...
		for _, test := range tests {
			t.Run(test.name, func(t *testing.T) {
				...
				err := ruleService.ReplaceRuleGroup(context.Background(), u, 1, group, test.from)
				require.NoError(t, err)

				group.Rules[0].Title = t.Name()
				err = ruleService.ReplaceRuleGroup(context.Background(), u, 1, group, test.to)
				if test.errNil {
					require.NoError(t, err)
				} else {
					require.Error(t, err)
	...
	t.Run("quota met causes group write to be rejected", func(t *testing.T) {
		...
		err := ruleService.ReplaceRuleGroup(context.Background(), u, 1, group, models.ProvenanceAPI)
...
func TestCreateAlertRule(t *testing.T) {
	...
	t.Run("when UID is specified", func(t *testing.T) {
		...
		t.Run("should create a new rule with this UID", func(t *testing.T) {
			...
			_, _, err = ruleService.GetAlertRule(context.Background(), u, orgID, uid)
			require.NoError(t, err)
		})
	})
}
