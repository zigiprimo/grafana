...
func addLibraryElementsMigrations(mg *migrator.Migrator) {
	...
	mg.AddMigration("add folder uid", migrator.NewAddColumnMigration(libraryElementsV1, &migrator.Column{
		Name: "folder_uid", Type: migrator.DB_NVarchar, Length: 40, Nullable: false, Default: "''",
	}))
	mg.AddMigration("populate folder_uid", migrator.NewRawSQLMigration("").
