...
func TestPluginManager_Add_Remove(t *testing.T) {
	t.Run("Adding a new plugin", func(t *testing.T) {
		...
		loader := &fakes.FakeLoader{
			LoadFunc: func(_ context.Context, src plugins.PluginSourceInstance) ([]*plugins.Plugin, error) {
		...
		t.Run("Update plugin to different version", func(t *testing.T) {
			...
			loader.LoadFunc = func(ctx context.Context, src plugins.PluginSourceInstance) ([]*plugins.Plugin, error) {
