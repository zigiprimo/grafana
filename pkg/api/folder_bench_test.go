...
func BenchmarkFolderListAndSearch(b *testing.B) {
	...
	benchmarks := []struct {
		...
		{
			desc:        "get root folders with nested folders feature enabled using new query",
			url:         "/api/folders",
			expectedLen: LEVEL0_FOLDER_NUM,
			features:    featuremgmt.WithFeatures(featuremgmt.FlagNestedFolders, featuremgmt.FlagNewPermissionFilter),
		},
		{
		...
		{
			desc:        "get subfolders with nested folders feature enabled using new query",
			url:         "/api/folders?parentUid=folder0",
			expectedLen: LEVEL1_FOLDER_NUM,
			features:    featuremgmt.WithFeatures(featuremgmt.FlagNestedFolders, featuremgmt.FlagNewPermissionFilter),
		},
		...
		{
			desc:        "list all inherited dashboards with nested folders feature enabled using new query",
			url:         "/api/search?type=dash-db&limit=5000",
			expectedLen: withLimit(all),
			features:    featuremgmt.WithFeatures(featuremgmt.FlagNestedFolders, featuremgmt.FlagNewPermissionFilter),
		},
		...
		{
			desc:        "search for pattern with nested folders feature enabled  using new query",
			url:         "/api/search?type=dash-db&query=dashboard_0_0&limit=5000",
			expectedLen: withLimit(1 + LEVEL1_DASHBOARD_NUM + LEVEL2_FOLDER_NUM*LEVEL2_DASHBOARD_NUM),
			features:    featuremgmt.WithFeatures(featuremgmt.FlagNestedFolders, featuremgmt.FlagNewPermissionFilter),
		},
		...
		{
			desc:        "search for specific dashboard nested folders feature enabled using new query",
			url:         "/api/search?type=dash-db&query=dashboard_0_0_0_0",
			expectedLen: 1,
			features:    featuremgmt.WithFeatures(featuremgmt.FlagNestedFolders, featuremgmt.FlagNewPermissionFilter),
		},
		...
		{
			desc:        "get root folders with nested folders feature disabled using new query",
			url:         "/api/folders?limit=5000",
			expectedLen: withLimit(LEVEL0_FOLDER_NUM),
			features:    featuremgmt.WithFeatures(featuremgmt.FlagNewPermissionFilter),
		},
		{
		...
		{
			desc:        "list all dashboards with nested folders feature disabled using new query",
			url:         "/api/search?type=dash-db&limit=5000",
			expectedLen: withLimit(LEVEL0_FOLDER_NUM * LEVEL0_DASHBOARD_NUM),
			features:    featuremgmt.WithFeatures(featuremgmt.FlagNewPermissionFilter),
		},
		...
		{
			desc:        "search specific dashboard with nested folders feature disabled  using new query",
			url:         "/api/search?type=dash-db&query=dashboard_0_0",
			expectedLen: 1,
			features:    featuremgmt.WithFeatures(featuremgmt.FlagNewPermissionFilter),
		},
