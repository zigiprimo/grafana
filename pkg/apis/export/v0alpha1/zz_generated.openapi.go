...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/grafana/grafana/pkg/apis/export/v0alpha1.ComponentStatus":         schema_pkg_apis_export_v0alpha1_ComponentStatus(ref),
		"github.com/grafana/grafana/pkg/apis/export/v0alpha1.ExportSpec":              schema_pkg_apis_export_v0alpha1_ExportSpec(ref),
		"github.com/grafana/grafana/pkg/apis/export/v0alpha1.ExportStatus":            schema_pkg_apis_export_v0alpha1_ExportStatus(ref),
		"github.com/grafana/grafana/pkg/apis/export/v0alpha1.ExportableComponent":     schema_pkg_apis_export_v0alpha1_ExportableComponent(ref),
		"github.com/grafana/grafana/pkg/apis/export/v0alpha1.ExportableComponentList": schema_pkg_apis_export_v0alpha1_ExportableComponentList(ref),
		"github.com/grafana/grafana/pkg/apis/export/v0alpha1.ExportableComponentSpec": schema_pkg_apis_export_v0alpha1_ExportableComponentSpec(ref),
		"github.com/grafana/grafana/pkg/apis/export/v0alpha1.GrafanaExportInfo":       schema_pkg_apis_export_v0alpha1_GrafanaExportInfo(ref),
		"github.com/grafana/grafana/pkg/apis/export/v0alpha1.GrafanaExportInfoList":   schema_pkg_apis_export_v0alpha1_GrafanaExportInfoList(ref),
		"github.com/grafana/grafana/pkg/apis/export/v0alpha1.JobStatus":               schema_pkg_apis_export_v0alpha1_JobStatus(ref),
...
func schema_pkg_apis_export_v0alpha1_ComponentStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
...
func schema_pkg_apis_export_v0alpha1_ExportSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"note": {
						SchemaProps: spec.SchemaProps{
							Description: "Optional note for this backup instance",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"include": {
						SchemaProps: spec.SchemaProps{
							Description: "The components that should be backed up",
							Type:        []string{"array"},
...
func schema_pkg_apis_export_v0alpha1_ExportStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Updated periodically by the process",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"state": {
						SchemaProps: spec.SchemaProps{
					...
					"components": {
						SchemaProps: spec.SchemaProps{
							Description: "Each of the components that make the export",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/grafana/grafana/pkg/apis/export/v0alpha1.ComponentStatus"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/grafana/grafana/pkg/apis/export/v0alpha1.ComponentStatus"},
	}
}

func schema_pkg_apis_export_v0alpha1_ExportableComponent(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Virtual resource that represents something that can be exported",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/grafana/grafana/pkg/apis/export/v0alpha1.ExportableComponentSpec"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/grafana/grafana/pkg/apis/export/v0alpha1.ExportableComponentSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_export_v0alpha1_ExportableComponentList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/grafana/grafana/pkg/apis/export/v0alpha1.ExportableComponent"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/grafana/grafana/pkg/apis/export/v0alpha1.ExportableComponent", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_export_v0alpha1_ExportableComponentSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_pkg_apis_export_v0alpha1_GrafanaExportInfo(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/grafana/grafana/pkg/apis/export/v0alpha1.ExportSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/grafana/grafana/pkg/apis/export/v0alpha1.ExportStatus"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/grafana/grafana/pkg/apis/export/v0alpha1.ExportSpec", "github.com/grafana/grafana/pkg/apis/export/v0alpha1.ExportStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_export_v0alpha1_GrafanaExportInfoList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "List of datasource and their status",
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/grafana/grafana/pkg/apis/export/v0alpha1.GrafanaExportInfo"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/grafana/grafana/pkg/apis/export/v0alpha1.GrafanaExportInfo", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_export_v0alpha1_JobStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
