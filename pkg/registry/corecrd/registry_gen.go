...
import (
	...
	folder "github.com/grafana/grafana/pkg/kinds/folder/crd"
...
// Folder returns the [k8ssys.Kind] instance for the Folder kind.
func (r *Registry) Folder() k8ssys.Kind {
	return r.all[1]
}
...
func doNewRegistry(breg *corekind.Base) *Registry {
	...
	kk = k8ssys.Kind{
		GrafanaKind: breg.Folder(),
		Object:      &folder.Folder{},
		ObjectList:  &folder.FolderList{},
	}
	// TODO Having the committed form on disk in YAML is worth doing this for now...but fix this silliness
