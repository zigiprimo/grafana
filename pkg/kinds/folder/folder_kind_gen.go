...
type Kind struct {
	kindsys.Core
	lin    thema.ConvergentLineage[*Folder]
	jcodec vmux.Codec
	valmux vmux.ValueMux[*Folder]
}
...
func NewKind(rt *thema.Runtime, opts ...thema.BindOption) (*Kind, error) {
	...
	tsch, err := thema.BindType[*Folder](cursch, &Folder{})
	if err != nil {
...
// to the the Folder type generated from the current schema, v0.0.
func (k *Kind) ConvergentLineage() thema.ConvergentLineage[*Folder] {
	return k.lin
}

// JSONValueMux is a version multiplexer that maps a []byte containing JSON data
// at any schematized dashboard version to an instance of Folder.
//
// Validation and translation errors emitted from this func will identify the
// input bytes as "dashboard.json".
//
// This is a thin wrapper around Thema's [vmux.ValueMux].
func (k *Kind) JSONValueMux(b []byte) (*Folder, thema.TranslationLacunas, error) {
	return k.valmux(b)
}
